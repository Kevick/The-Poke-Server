...
void mainLoader(int argc, char* argv[], ServiceManager* services)
{
...
#endif
	std::cout << " " << STATUS_SERVER_NAME << " Versao atual: (" << STATUS_SERVER_VERSION << "." << MINOR_VERSION << " . " << REVISION_VERSION << ") - Nome de desenvolvimento: ( " << SOFTWARE_CODENAME << " )" << std::endl;
	std::cout << "Compilado com: " << BOOST_COMPILER << std::endl;
	std::cout << "Na data " << __DATE__ << ' ' << __TIME__ << " Para a plataforma: ";
	...
	std::cout << "Feito por " << STATUS_SERVER_DEVELOPERS << "." << std::endl;
	std::cout << "Erros: " << GIT_REPO <<"." << std::endl;
	std::cout << std::endl;
